...
public class CharacterCam : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        // 카메라의 위치와 각도 변경
        transform.rotation = Quaternion.Euler(mCameraRotateValueY, mCameraRotateValueX, 0);
        transform.position = transform.rotation * new Vector3(0, 0.0f, -4f) + mTarget.position;
